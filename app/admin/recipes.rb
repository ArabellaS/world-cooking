ActiveAdmin.register Recipe do
  ...
  permit_params :content, :place_id, :name, :sourness, :spiciness, :saltiness, :savoriness, :sweetness, :bitterness, :fattiness, quantities_attributes: [ :id, :field_name, :text, :_destroy ]
